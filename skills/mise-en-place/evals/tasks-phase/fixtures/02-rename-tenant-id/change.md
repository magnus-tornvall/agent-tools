...
plan:
  approach: "Introduce the new name beside the old, move call sites package by package, then remove the old name."
  touchpoints:
  ...
  constraints:
    - "The old name keeps working until the last call site has moved."
    - "No batch spans two packages."
  acceptance: "bun test"
  escalate_if:
